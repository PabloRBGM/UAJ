...
class 1ArcadeController : public FightController
{

public:
	1ArcadeController(int roundIniTime, int roundEndTime) : FightController(roundIniTime, roundEndTime) {}
