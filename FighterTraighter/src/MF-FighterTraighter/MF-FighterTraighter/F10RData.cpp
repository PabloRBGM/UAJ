...
void F10RData::NP1(Entity* ent)
{
	...
	ent->getApp()->getStateMachine()->getCurrentState()->addHitbox(
		...
		{ (double)orientation_ * np1.knockBack.getX(), np1.knockBack.getY() }, pT->getBody(), pD->getPlayerNumber(),
		ent, pT->getCategory(), pT->getMask(), false, Attacks::NormalPunch);
...
void F10RData::HP1(Entity* ent)
{
	...
	ent->getApp()->getStateMachine()->getCurrentState()->addHitbox(
		...
		{ (double)orientation_ * hp1.knockBack.getX(), hp1.knockBack.getY() }, pT->getBody(), 
		pD->getPlayerNumber(), ent, pT->getCategory(), pT->getMask(), false, Attacks::HeavyPunch);
...
void F10RData::NK1(Entity* ent)
{
	...
	ent->getApp()->getStateMachine()->getCurrentState()->addHitbox(
		...
		{ (double)orientation_ * nk1.knockBack.getX(), nk1.knockBack.getY() }, pT->getBody(), pD->getPlayerNumber(),
		ent, pT->getCategory(), pT->getMask(), false, Attacks::NormalKick);
...
void F10RData::ANP1(Entity* ent)
{
	...
	ent->getApp()->getStateMachine()->getCurrentState()->addHitbox(
		...
		{ (double)orientation_ * anp1.knockBack.getX(), anp1.knockBack.getY() }, pT->getBody(), pD->getPlayerNumber(), ent, pT->getCategory(), pT->getMask(), false, Attacks::AirNormalPunch);
...
void F10RData::AHP1(Entity* ent)
{
	...
	dT->attackID_ = Attacks::AirHeavyPunch;
...
void F10RData::ANK1(Entity* ent)
{
	...
	dT1->attackID_ = Attacks::AirNormalKick;
	dT2->attackID_ = Attacks::AirNormalKick;
	dT3->attackID_ = Attacks::AirNormalKick;
...
void F10RData::AHK1(Entity* ent)
{
	...
	ent->getApp()->getAudioMngr()->playSFX(ent->getApp()->getAssetsManager()->getSFX(AssetsManager::KICK), false, Attacks::AirHeavyKick);
...
void F10RData::GB(Entity* ent)
{
	...
	ent->getApp()->getAudioMngr()->playSFX(ent->getApp()->getAssetsManager()->getSFX(AssetsManager::POWER2), false, Attacks::GuardBreaker);
