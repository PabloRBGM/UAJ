...
void Iv1Controller::PlayerLost(int playerNumber)
{
...
void Iv1Controller::end()
{
	app_->getGameManager()->AIWin();

}

void Iv1Controller::disablePlayers(bool mode) {
